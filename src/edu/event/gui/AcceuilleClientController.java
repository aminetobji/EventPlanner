 ...
 * @author Amine
 */
public class AcceuilleClientController implements Initializable {
    ...
    private void Commande(ActionEvent event) {
        ...
        Parent root;
        try {
            root = FXMLLoader.load(getClass().getResource("CommandeGestion.fxml"));
    ...
    private void evenement(ActionEvent event) {
        ...
        Parent root;
        try {
            root = FXMLLoader.load(getClass().getResource("ShowEvenement.fxml"));
            Stage myWindow = (Stage) btn.getScene().getWindow();
            Scene sc = new Scene(root);
            myWindow.setScene(sc);
            myWindow.setTitle("page name");
    ...
    private void Produit(ActionEvent event) {
        ...
        Parent root;
        try {
            root = FXMLLoader.load(getClass().getResource("ShowProduit.fxml"));
            Stage myWindow = (Stage) btn.getScene().getWindow();
            Scene sc = new Scene(root);
            myWindow.setScene(sc);
            myWindow.setTitle("page name");
